...
public class AdminHomeView extends javax.swing.JPanel {
    ...
    public AdminHomeView(BankApps app) {
        this.app = app;
        this.tableContent = new DefaultTableModel(new Object[][]{}, new String[]{
            "No", "Nama Awal", "Nama Akhir", "Saldo", "PIN"
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(177, 177, 177)
                        .addComponent(btnKeluar, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(namaAkhir, javax.swing.GroupLayout.PREFERRED_SIZE, 499, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(namaAwal, javax.swing.GroupLayout.PREFERRED_SIZE, 499, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(pin, javax.swing.GroupLayout.PREFERRED_SIZE, 499, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (!namaAwal.equals("") && !namaAkhir.equals("")) {
            if (btnAdd.getText().equals("Add")) {
                try {
                    ...
                    app.getBank().tambahNasabah(namaAwal, namaAkhir, saldo, pin);
            ...
            try {
                ...
                if (selectedRow >= 0) {
                    ...
                    app.getBank().updateNasabah(selectedRow, new Nasabah(namaAwal, namaAkhir), saldo, pin);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (selectedRow >= 0) {
            ...
            this.pin.setText(this.tableContent.getValueAt(selectedRow, 4).toString());
        }
